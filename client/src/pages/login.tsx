    ...
    <div className="min-h-screen flex bg-gradient-to-br from-[#0f0f23] via-[#1a1a2e] to-[#16213e] p-4 text-white gap-2">
      ...
      >
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Elegant Social Login Buttons */}
          <div className="grid grid-cols-4 gap-4">
            <button className="flex items-center justify-center w-12 h-12 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group">
