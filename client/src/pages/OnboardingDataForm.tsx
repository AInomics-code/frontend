  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-8 py-12 relative z-10">
        {/* Microsoft Copilot Studio style header */}
        <motion.div 
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-semibold text-slate-900" style={{ 
                  fontFamily: '"Segoe UI", system-ui, sans-serif',
                  fontWeight: 600
                }}>
                  Connect your data sources
                </h1>
                <p className="text-slate-500 text-sm mt-1" style={{ 
                  fontFamily: '"Segoe UI", system-ui, sans-serif'
                }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900" style={{ 
                      fontFamily: '"Segoe UI", system-ui, sans-serif',
                      fontSize: '16px'
                    }}>
                      Database connection
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 bg-slate-50 border border-slate-300 rounded-md text-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 bg-slate-50 border border-slate-300 rounded-md text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm"
                      style={{ fontFamily: '"Segoe UI", system-ui, sans-serif' }}
                    />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3 py-2.5 pr-10 bg-slate-50 border border-slate-300 rounded-md text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm"
                        style={{ fontFamily: '"Segoe UI", system-ui, sans-serif' }}
                      />
                      <button
                        type="button"
            ...
            >
              <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                    ...
                    >
                      <div className="flex-1">
                        <textarea
                          ...
                          rows={2}
                          className="w-full px-3 py-2.5 bg-slate-50 border border-slate-300 rounded-md text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none text-sm"
                          style={{ fontFamily: '"Segoe UI", system-ui, sans-serif' }}
                        />
                      </div>
                ...
                <button
                  ...
                  className="mt-4 flex items-center gap-2 px-3 py-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-md transition-all text-sm font-medium"
                  style={{ fontFamily: '"Segoe UI", system-ui, sans-serif' }}
                >
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="px-2 py-0.5 text-xs bg-slate-100 text-slate-600 rounded-full font-medium">Optional</span>
                    </div>
                    <p className="text-slate-500 text-sm">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              ...
              {/* Connection Status */}
              <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                <h4 className="font-semibold text-slate-900 mb-4" style={{ 
                  fontFamily: '"Segoe UI", system-ui, sans-serif',
                  fontSize: '14px'
                }}>
                  Setup progress
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-slate-600">Business questions</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-slate-400">Business context (optional)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                <h4 className="font-semibold text-slate-900 mb-3" style={{ 
                  fontFamily: '"Segoe UI", system-ui, sans-serif',
                  fontSize: '14px'
                }}>
                  💡 Setup tips
        ...
        {/* Microsoft-style bottom actions bar */}
        <motion.div 
          className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-8 py-4 z-50"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-6 py-2.5 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-all duration-200 font-medium border border-slate-300"
                style={{ 
                  fontFamily: '"Segoe UI", "Inter", system-ui, sans-serif'
                }}
              >
              ...
              <motion.button
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-200"
                style={{ 
                  fontFamily: '"Segoe UI", "Inter", system-ui, sans-serif'
                }}
                whileHover={{ 
